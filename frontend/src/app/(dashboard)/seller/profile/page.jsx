...
import { FaUser, FaEnvelope, FaPhone, FaCoins, FaEdit, FaSave, FaTimes } from 'react-icons/fa';
    ...
    <div className="p-4 sm:p-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6 sm:mb-8">
        <div>
          ...
          <p className="text-blue-200 mt-1 sm:mt-2">Manage your seller account</p>
        </div>
        <button
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-4 sm:p-6 border border-white/20">
          <div className="flex items-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-500/20 rounded-xl flex items-center justify-center mr-3 sm:mr-4 border border-purple-400/30">
              <FaUser className="text-lg sm:text-xl text-purple-400" />
            </div>
            <div>
              <p className="text-xs sm:text-sm font-medium text-blue-200">Status</p>
              <p className="text-xl sm:text-2xl font-bold text-white capitalize">{user.status}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-4 sm:p-6 border border-white/20">
          <div className="flex items-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-500/20 rounded-xl flex items-center justify-center mr-3 sm:mr-4 border border-yellow-400/30">
              <FaUser className="text-lg sm:text-xl text-yellow-400" />
            </div>
            <div>
              <p className="text-xs sm:text-sm font-medium text-blue-200">Level</p>
              <p className="text-xl sm:text-2xl font-bold text-white capitalize">{user.level || 'Level 1'}</p>
            </div>
          </div>
        </div>
      </div>
