...
import { FaUser, FaEnvelope, FaPhone, FaCoins, FaEdit, FaSave, FaTimes, FaShoppingCart, FaHistory, FaHeart } from 'react-icons/fa';
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6 sm:mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-white">Buyer Profile</h1>
          <p className="text-blue-200 mt-1 sm:mt-2">Manage your account and purchase history</p>
        </div>
        <button
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-4 sm:p-6 border border-white/20">
          <div className="flex items-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-500/20 rounded-xl flex items-center justify-center mr-3 sm:mr-4 border border-blue-400/30">
              <FaUser className="text-lg sm:text-xl text-blue-400" />
            </div>
            <div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-4 sm:p-6 border border-white/20">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xl sm:text-2xl font-bold text-white">{user.buyerData?.purchaseHistory?.length || 0}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-lg p-4 sm:p-6 border border-white/20">
          <div className="flex items-center">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-yellow-500/20 rounded-xl flex items-center justify-center mr-3 sm:mr-4 border border-yellow-400/30">
              <FaHeart className="text-lg sm:text-xl text-yellow-400" />
            </div>
            <div>
              <p className="text-xs sm:text-sm font-medium text-blue-200">Favorite Sellers</p>
              <p className="text-xl sm:text-2xl font-bold text-white">{user.buyerData?.favoriteSellers?.length || 0}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded-lg p-4">
              ...
              <p className="text-white font-semibold text-xl">
                {user.buyerData?.totalSpent || 0} pts
              </p>
            </div>
            <div className="bg-white/5 rounded-lg p-4">
              <p className="text-blue-200 text-sm">Cart Items</p>
              <p className="text-white font-semibold text-xl">
                {user.buyerData?.cart?.length || 0}
              </p>
            </div>
            <div className="bg-white/5 rounded-lg p-4">
              <p className="text-blue-200 text-sm">Purchase History</p>
              <p className="text-white font-semibold text-xl">
                {user.buyerData?.purchaseHistory?.length || 0} items
              </p>
            </div>
          </div>
        </div>
